...
const Header = (props) => (
  ...
  <thead>
    <tr style={{verticalAlign:"middle",backgroundColor:"initial"}}>
      ...
      <td className="mui--appbar-height " align="right" style={{padding:"15px"}}> <a href='/blog/post-1.html' className="mui--text-right" style={{color:"white"}}>Blog</a> | <a href='/about.html' className="mui--text-right" style={{color:"white"}}>About Us</a> </td>
    </tr>
  </thead>
  </table>
  </header>
